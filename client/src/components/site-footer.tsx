...
const platformLinks = [
  {
    name: "Spotify",
    href: "https://open.spotify.com/show/7rqHuCjQgKRupe5CdyZZxF",
    icon: (
  ...
  {
    name: "Apple Podcasts",
    href: "https://podcasts.apple.com/us/podcast/the-pressure-play/id1234567890",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://youtube.com/@thepressureplay",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    href: "https://podcasts.google.com/feed/aHR0cHM6Ly90aGVwcmVzc3VyZXBsYXkucnNz",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
const socialLinks = [
  {
    name: "Twitter",
    href: "https://twitter.com/thepressureplay",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "LinkedIn",
    href: "https://linkedin.com/company/thepressureplay",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4 lg:px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border-t border-border pt-8 mb-8">
            <h3 className="font-semibold mb-4 text-center">Listen On</h3>
